...
<div class="form-container">
    <div class="card">
        <div class="card-header">
            <div class="card-title">✏️ Edit Berita</div>
        </div>
            ...
            <div class="form-group">
                ...
                @if ($berita->gambar)
                    <div style="margin-bottom: 10px;">
                        <div style="font-size: 0.875rem; color: #718096; margin-bottom: 5px;">Gambar Saat Ini:</div>
                        <img src="{{ asset('storage/' . $berita->gambar) }}" alt="{{ $berita->judul }}" class="current-image">
                    </div>
                @endif
                ...
                @error('gambar')
                    <div class="error-text">{{ $message }}</div>
                @enderror
                <div class="form-hint">Upload gambar baru jika ingin mengganti (Max: 5MB)</div>
            </div>
